...
const enCommon = {
  ...
  deleteAccount: {
    heading: "danger zone",
    intro: "closing your account erases it and everything stored in it.",
    ...
    ownedHeading: "projects you own — deleted for everyone:",
    projectMembers_one: "{{count}} other member loses access",
    projectMembers_other: "{{count}} other members lose access",
    projectMembersNone: "no other members",
    othersAffected_one: "{{count}} other person loses access.",
    othersAffected_other: "{{count}} other people lose access.",
    othersAffectedNone: "nobody else has access to these projects.",
    ...
    vaultWarning:
      "your vault goes with it — every host, ssh key and stored password. we only ever held ciphertext, so <1>this cannot be undone</1>: there is no recovery path and support cannot restore it.",
    emailPrompt: "type <1>{{email}}</1> below to confirm.",
    passwordPrompt: "then enter your master password.",
